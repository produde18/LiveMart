    ...
    <Layout>
      ...
      >
        ...
        >
          <div className="delAdrContainer">
            ...
            <div className="delMoreActionContainer">
                ...
                Delivery Agent</div>
              <div className ="delName">{orderDetails.Delivery} 
              </div> <br/>
        ...
        {orderDetails.items.map((item, index) => (
          <Card
            style={{ display: "flex", padding: "25px 10px", margin: "8px 0px" }}
          >
            <div  className="flexRow">
              ...
              <div style={{ width: "250px" }}>
                <div style={{ display: "flex", padding: "3px 3px", margin: "6px 6px" }} className="delItemName">{item.productId.name}</div>
                {/* <a href = "http://localhost:3000/+{item.productId.name}+/{item.productId}">Give Reviews</a> */}
